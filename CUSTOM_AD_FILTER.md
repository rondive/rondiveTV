...
rondiveTV 提供强大的自定义去广告功能，允许管理员编写 JavaScript 代码实现更精准的 M3U8 视频流广告过滤。
...
- rondiveTV Issues - 提交 Bug 或功能建议
- rondiveTV Discussions - 讨论去广告规则和最佳实践
...
- rondiveTV 自定义去广告功能遵循 rondiveTV 项目许可证
- 去广告功能仅供学习和研究使用
- 请遵守当地法律法规和版权规定
