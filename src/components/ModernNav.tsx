...
export default function ModernNav() {
  ...
  useEffect(() => {
    ...
    if (typeof (window as any).requestIdleCallback === 'function') {
      idleId = (window as any).requestIdleCallback(runPrefetch, { timeout: 1500 });
    } else {
      timeoutId = window.setTimeout(runPrefetch, 800);
    }
