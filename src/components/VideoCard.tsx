...
const VideoCard = forwardRef<VideoCardHandle, VideoCardProps>(
  function VideoCard(
    ...
    const actionSheetTimerRef = useRef<number | null>(null);
    ...
    useEffect(() => {
      if (showMobileActions) {
        if (actionSheetTimerRef.current !== null) {
          clearTimeout(actionSheetTimerRef.current);
          actionSheetTimerRef.current = null;
        }
        setIsActionSheetMounted(true);
      } else if (isActionSheetMounted) {
        actionSheetTimerRef.current = window.setTimeout(() => {
    ...
    }, [showMobileActions, isActionSheetMounted]);
          ...
          >
            ...
            <div
              ...
              style={{
                ...
                backgroundPosition: 'var(--shimmer-position) 0',
                    ...
                    >
                      ...
                      >
                        <span className='flex flex-col items-center justify-center leading-none'>
                          <span className='text-[9px] @[180px]:text-[10px] font-normal'>
                            源
                          </span>
                          <span className='text-xs @[180px]:text-sm font-extrabold'>
                            {sourceCount}
                          </span>
                        </span>
                      </div>
