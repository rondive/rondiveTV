...
export default function HeroBanner({
  ...
  const getProxiedImageUrl = (url: string) => processImageUrl(url);
  const getTencentFallbackUrl = (url: string) =>
              ...
              <Image
                ...
                onError={(e) => {
                  ...
                  if (fallbackStep === 'server') {
                    ...
                    if (tencentUrl && tencentUrl !== item.poster) {
                      target.src = tencentUrl;
                      return;
                    }
                  }
                  if (fallbackStep === 'tencent') {
                    target.dataset.doubanFallback = 'direct';
